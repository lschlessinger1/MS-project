...
from src.evalg.genprog import HalfAndHalfMutator, OnePointLeafBiasedRecombinator
...
dataset = SyntheticRegressionDataset(n_samples=100)
...
experiment = Experiment(grammar, kernel_selector, objective, base_kernels, x_train, y_train, x_train, y_train,
                        eval_budget=50, additive_form=True, debug=True, verbose=True, max_null_queries=50,
