...
def euclidean_kernel_kernel(x_train: ndarray, **kwargs) -> KernelKernel:
    """Construct a kernel kernel using the SHD metric.
...
def hellinger_kernel_kernel(x_train: ndarray, **kwargs) -> KernelKernel:
    """
    ...
    return KernelKernel(distance_metric=hellinger_metric, dm_kwargs_dict=input_dict, **kwargs)
