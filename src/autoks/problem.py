...
class CKSProblem(Problem):
    ...
    def __init__(self,
                 ...
                 num_dimensions: int,
                 data_X: ndarray):
        super().__init__(budget, base_kernel_names, num_dimensions, data_X)
...
class BomsProblem(Problem):
    ...
    def __init__(self, budget: int,
                 ...
                 verbose: Optional[bool] = None):
        super().__init__(budget, base_kernel_names, num_dimensions, data_X, verbose)
